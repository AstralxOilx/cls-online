...
type ResponseType = Id<"submitAssignments"> | null;
...
export const useReSubmitAssignment = () => {
    ...
    const resubmitAssignment = useMutation(api.submitAssignment.resubmitAssignment);
    ...
    const mutate = useCallback(async (
        ...
        try {
            ...
            const response = await resubmitAssignment({
                ...rest,
                files: uploadedFiles,
              });
    ...
    }, [generateUploadUrl, resubmitAssignment]);
